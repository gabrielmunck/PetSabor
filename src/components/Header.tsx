    ...
    return (
        <header className="bg-forest-green text-white h-14 p-1 fixed top-0 left-0 right-0 z-10">
            <div className="flex items-center h-full px-10">
                <nav className="container mx-auto flex items-center justify-around sm:justify-start">
                    <button
                        onClick={() => scrollToSection("home")}
                        className="mr-0 sm:mr-9 font-sans hover:text-pet-orange transition-colors duration-300"
                    >
                        Home
                    </button>
                    <button
                    ...
                    <button
                        ...
                        className="font-sans hover:text-pet-orange transition-colors duration-300"
                    >
                        Contact
                    </button>
                </nav>
